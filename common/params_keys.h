...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"ShowAdvancedControls", {PERSISTENT, BOOL, "1"}},
    {"ModelManager_ModelsCache", {PERSISTENT, JSON}},
    {"ModelManager_LastSyncTime", {PERSISTENT, INT, "0"}},
    {"ModelManager_ActiveBundle", {PERSISTENT, JSON}},
    {"ModelManager_DownloadIndex", {CLEAR_ON_MANAGER_START, INT}},
    {"ModelManager_ClearCache", {CLEAR_ON_MANAGER_START, BOOL}},
    {"ModelManager_DeleteBundleRef", {CLEAR_ON_MANAGER_START, STRING}},
    {"ModelManager_Favs", {PERSISTENT, STRING}},
    {"ModelRunnerTypeCache", {PERSISTENT, INT, "2"}},
    {"LagdToggle", {PERSISTENT, BOOL, "1"}},
    {"LagdToggleDelay", {PERSISTENT, FLOAT, "0.2"}},
    {"LagdValueCache", {PERSISTENT, FLOAT}},
    {"LaneTurnDesire", {PERSISTENT, BOOL, "0"}},
    {"LaneTurnValue", {PERSISTENT, FLOAT, "19.0"}},
